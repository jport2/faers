...
# os.chdir("../../data/jportanova/FAERS/ascii/unique2d")
input = pd.read_csv("inputweightvectors.txt", skiprows=1, sep="|", header=None, error_bad_lines=False) # error bad lines in input (Drugs again) this time
